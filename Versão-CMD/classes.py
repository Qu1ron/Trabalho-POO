...
class Mago(Personagem):
    def __init__(self, name, MaxHp = 110, Hp = 110, MaxMp = 150, Mp = 150, Defense = 15, Speed = 10, skills = Ataques, arte = mago_arte, arte_invertida = mago_inv_arte):
...
class Guerreiro(Personagem):
    def __init__(self, name, MaxHp = 100, Hp = 100, MaxMp = 110, Mp = 110, Defense = 30, Speed = 7, skills = Ataques, arte = guerreiro_arte, arte_invertida = guerreio_inv_arte):
        super().__init__(name, MaxHp, Hp, MaxMp, Mp, Defense, Speed)
        self.arte = arte
        self.arte_inv = arte_invertida
...
class Arqueiro(Personagem ) :
    def __init__ (self ,name, MaxHp = 100 ,Hp = 100 ,MaxMp = 125 ,Mp = 125 ,Defense = 20 ,Speed = 15 ,skills = Ataques, arte = arqueiro_arte, arte_invertida = arqueiro_inv_arte) :
        super().__init__( name ,MaxHp ,Hp ,MaxMp ,Mp ,Defense ,Speed)
        self.arte = arte
        self.arte_inv = arte_invertida
