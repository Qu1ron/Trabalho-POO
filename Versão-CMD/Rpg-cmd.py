...
class Personagem:
    ...
    def dodge(self):
        ...
        self.chance_desvio = base_chance + sorte #Entao se voce tem 100 de speed, 50 de base chance + de 0 a 10 dependendo da sorte
        self.rolagem = random.randint(0,100) #pensa num dado de 100 lados, se o numero que sair for menor que a chance, vc toma :P
        if chance_desvio < rolagem:
            return False
        else: 
            return True
